...
from ecommerce import api, fields, models, Command, _
from ecommerce.exceptions import ValidationError, UserError, RedirectWarning
from ecommerce.tools import frozendict, formatLang, format_date, float_compare, Query
from ecommerce.tools.sql import create_index
from ecommerce.addons.web.controllers.utils import clean_action
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_reconciliation_single_partial(self, debit_vals, credit_vals):
        ...
        def get_ecommerce_rate(vals, other_line=None):
        ...
        if debit_vals['currency'] == credit_vals['currency'] == company_currency \
            ...
            debit_rate = get_ecommerce_rate(debit_vals, other_line=credit_vals)
            ...
            credit_rate = get_ecommerce_rate(credit_vals, other_line=debit_vals)
