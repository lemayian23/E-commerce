{
    'name': 'Base import',
    'description': """
New extensible file import for ecommerce
======================================

Re-implement ecommerce's file import system:
...
* In a module, so that administrators and users of ecommerce who do not
