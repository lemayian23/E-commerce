...
from ecommerce import api, release, SUPERUSER_ID
from ecommerce.exceptions import UserError
from ecommerce.models import AbstractModel
from ecommerce.tools.translate import _
from ecommerce.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to ecommerce's publisher warranty server to check the
