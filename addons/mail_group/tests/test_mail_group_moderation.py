...
from ecommerce.addons.mail_group.tests.data import GROUP_TEMPLATE
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('ecommerce.models.unlink', 'ecommerce.addons.mail_group.models.mail_group_message')
    @users('employee')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('ecommerce.addons.mail.models.mail_thread', 'ecommerce.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('ecommerce.addons.mail.models.mail_thread', 'ecommerce.addons.mail_group.models.mail_group_message', 'ecommerce.models.unlink')
    @users('employee')
    ...
    @mute_logger('ecommerce.addons.mail_group.models.mail_group')
    @users('employee')
