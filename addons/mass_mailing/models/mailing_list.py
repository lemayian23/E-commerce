...
from ecommerce import _, Command, fields, models
...
class MassMailingList(models.Model):
    ...
    def action_merge(self, src_lists, archive):
        ...
        # A (id=4): yti@ecommerce.com; yti@example.com
        # B (id=5): yti@ecommerce.com; yti@openerp.com
        # C (id=6): nothing
        ...
        # ------------+---------------------------+------------------------
        #           4 | yti@ecommerce.com              |          1 |        4 |
        #           6 | yti@ecommerce.com              |          2 |        5 |
