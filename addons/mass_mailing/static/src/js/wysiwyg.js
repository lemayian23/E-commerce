ecommerce.define('mass_mailing.wysiwyg', function (require) {
'use strict';

var Wysiwyg = require('web_editor.wysiwyg');
var MassMailingSnippetsMenu = require('mass_mailing.snippets.editor');
const {closestElement} = require('@web_editor/js/editor/ecommerce-editor/src/ecommerceEditor');
...
const MassMailingWysiwyg = Wysiwyg.extend({
    ...
    toggleLinkTools(options = {}) {
        ...
        if (this.snippetsMenu.folded) {
            ...
            this.ecommerceEditor.document.getSelection().collapseToEnd();
        }
    },
    ...
    setSnippetsMenuFolded: async function (fold = true) {
        if (fold) {
            ...
            if (!this.floatingToolbar) {
                ...
                this.ecommerceEditor.setupToolbar(this.toolbar.el);
