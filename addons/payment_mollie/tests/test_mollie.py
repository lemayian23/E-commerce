...
from ecommerce.addons.payment_mollie.controllers.main import MollieController
from ecommerce.addons.payment_mollie.tests.common import MollieCommon
...
class MollieTest(MollieCommon, PaymentHttpCommon):
    ...
    @mute_logger(
        'ecommerce.addons.payment_mollie.controllers.main',
        'ecommerce.addons.payment_mollie.models.payment_transaction',
    )
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'ecommerce.addons.payment_mollie.models.payment_provider.PaymentProvider'
