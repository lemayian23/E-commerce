...
from ecommerce.addons.sales_team.tests.common import TestSalesMC
from ecommerce.tests.common import users, TransactionCase
...
class TestCornerCases(TransactionCase):
    ...
    def test_unicity(self):
        ...
        with self.assertRaises(exceptions.UserError), mute_logger('ecommerce.sql_db'):
