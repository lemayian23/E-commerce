ecommerce.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in ecommerce.
 *
 * The basic concurrency primitives in ecommerce JS are the callback, and the
...
return {
    ...
    /**
     * A (ecommerce) mutex is a primitive for serializing computations.  This is
