ecommerce.define('web.mixins', function (require) {
"use strict";
...
function ecommerceEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
ecommerceEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

ecommerceEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new ecommerceEvent(this, name, info);
