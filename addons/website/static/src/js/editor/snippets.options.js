ecommerce.define('website.editor.snippets.options', function (require) {
'use strict';
...
options.registry.OptionsTab = options.Class.extend({
    ...
    async updateUI() {
        ...
        // If the gray palette has been generated by ecommerce standard option,
        ...
        // same hue by the ecommerce editor, there might be rounding errors
...
options.registry.Carousel = options.Class.extend({
     ...
     */
    async _addSlide() {
        this.options.wysiwyg.ecommerceEditor.historyPauseSteps();
        ...
        this.options.wysiwyg.ecommerceEditor.historyUnpauseSteps();
    },
    /**
