...
from ecommerce.addons.crm.models import crm_stage
...
class CRMRevealRule(models.Model):
    ...
    industry_tag_ids = fields.Many2many('crm.iap.lead.industry', string='Industries', help='Leave empty to always match. ecommerce will not create lead if no match')
    ...
    # Methods responsible for format response data in to valid ecommerce lead data
