...
from ecommerce.addons.website_sale_autocomplete.controllers.main import AutoCompleteController
from ecommerce.tests import patch, HttpCase, tagged

CONTROLLER_PATH = 'ecommerce.addons.website_sale_autocomplete.controllers.main.AutoCompleteController'
