# Sign the ecommerce CLA

In order for your contribution to ecommerce to be accepted, you have to sign the
ecommerce Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [ecommerce/ecommerce](https://github.com/ecommerce/ecommerce), adding a new file
...
3. An ecommerce R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [ecommerce/ecommerce](/ecommerce/ecommerce), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is ecommerce, the file would be
    `doc/cla/corporate/ecommerce.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the ecommerce Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `ecommerce.com`.  In that case someone from the ecommerce team will
make the pull request on your behalf.

* Printable ecommerce CCLA v1.0 https://www.ecommerce.com/files/legal/ecommerce-CCLA-v1.0.pdf
* Printable ecommerce ICLA v1.0 https://www.ecommerce.com/files/legal/ecommerce-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for ecommerce is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the ecommerce project

* protect the ecommerce project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the ecommerce project and its users from bad actors who would contribute
...
contributor really intended to contribute to the ecommerce project under specific
...
The ecommerce CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, ecommerce S.A. to use, modify and
...
(ICLA) of ecommerce.  The agreement is executed by adding your name and
...
removed from the ecommerce project.
