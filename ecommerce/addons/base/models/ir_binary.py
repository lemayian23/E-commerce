...
from ecommerce.exceptions import MissingError, UserError
from ecommerce.http import Stream, request
from ecommerce.tools import file_open, replace_exceptions
from ecommerce.tools.image import image_process, image_guess_size_from_field_name
from ecommerce.tools.mimetypes import guess_mimetype, get_extension
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:ecommerce.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~ecommerce.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`ecommerce.tools.image.image_process`.
