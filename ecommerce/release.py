...
long_desc = '''ecommerce is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'OpenERP S.A.'
author_email = 'info@ecommerce.com'
license = 'LGPL-3'

nt_service_name = "ecommerce-server-" + series.replace('~','-')
